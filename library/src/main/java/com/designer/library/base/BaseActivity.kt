...
abstract class BaseActivity<B : ViewDataBinding> : AppCompatActivity(), OnClickListener {
    ...
    private fun registerBroadcast() {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(finishBroadcastReceiver!!, intentFilter)
    }
