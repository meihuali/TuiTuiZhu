 ...
 */
private constructor(private val context: Context, orientation: Int) : RecyclerView.ItemDecoration() {
    ...
    fun setDrawable(@DrawableRes drawableRes: Int): BaseItemDecoration {
        val drawable =
            context.resources.getDrawable(drawableRes) ?: throw IllegalArgumentException("Drawable cannot be null.")
        divider = drawable
        return this
    }
