...
/**
 * This is a Log tool，with this you can the following <ol> <li>use LogCat.d(),you could print
 * whether the method execute,and the default tag is current class's name</li> <li>use
 * LogCat.d(errorMessage),you could print log as before,and you could location the method with a click in
 * Android Studio Logcat</li> <li>use LogCat.json(),you could print json string with well format
 * automatic</li> </ol>
 *
 ...
 * 扩展功能，添加对自定义全局Tag的支持,修复内部类不能点击跳转的BUG 16/6/15  扩展功能，添加不能关闭的KLog.debug(),用于发布版本的Log打印,优化部分代码
...
public final class LogCat {
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.socks.library.klog.LogCat")) {
                continue;
            }
            sb.append(trace)
                    .append("\n");
