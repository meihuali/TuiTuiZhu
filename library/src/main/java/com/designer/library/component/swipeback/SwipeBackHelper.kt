...
class SwipeBackHelper constructor(private val mSwipeBackActivity: Activity) {
    ...
    fun getSwipeBackView(decorView: ViewGroup): ViewGroup {
        if (mSwipeBackView == null) {
            ...
            mSwipeBackView = decorView.findViewById<View>(Window.ID_ANDROID_CONTENT).parent as ViewGroup
        }
     ...
     * @param velocity      滑动速度
     */
    private fun startSwipeAnimator(startValue: Float, minFinalValue: Float, maxFinalValue: Float, velocity: Float) {
    ...
    private inner class PrivateListener : Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener,
