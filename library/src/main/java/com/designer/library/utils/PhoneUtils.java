...
public class PhoneUtils {
     ...
     */
    public static String getUniqueDeviceID2MD5() {
        Context context = Library.INSTANCE.getApp();
        String imei = "";
        String androidId = "";
        String macAddress = "";
        ...
        return EncryptUtil.encryptMD5ToString(longIdBuilder.toString());
    }
     ...
     * 给手机号码添加空格
     */
    public static String phoneNumberFormat(String tel) {
        if (tel != null && tel.length() == 11) {
            return tel.substring(0, 3) + " " + tel.substring(4, 7) + " " + tel.substring(8, 11);
        } else {
            return tel;
        }
    }
    ...
    public static boolean isPhone() {
        TelephonyManager tm = (TelephonyManager) Library.INSTANCE.getApp()
     ...
     * 获取移动终端类型
     *
     * @return 手机制式 <ul> <li>{@link TelephonyManager#PHONE_TYPE_NONE } : 0 手机制式未知</li> <li>{@link
     * TelephonyManager#PHONE_TYPE_GSM  } : 1 手机制式为GSM，移动和联通</li> <li>{@link
     * TelephonyManager#PHONE_TYPE_CDMA } : 2 手机制式为CDMA，电信</li> <li>{@link
     * TelephonyManager#PHONE_TYPE_SIP  } : 3</li> </ul>
     */
     ...
     * <p>需添加权限 {@code <uses-permission android:name="android.permission.READ_PHONE_STATE"/>}</p>
     *
     * @return DeviceId(IMEI) = 99000311726612<br> DeviceSoftwareVersion = 00<br> Line1Number =<br>
     * NetworkCountryIso = cn<br> NetworkOperator = 46003<br> NetworkOperatorName = 中国电信<br>
     * NetworkType = 6<br> honeType = 2<br> SimCountryIso = cn<br> SimOperator = 46003<br>
    ...
    public static void dial(String phoneNumber) {
        Library.INSTANCE.getApp()
                .startActivity(IntentUtils.getDialIntent(phoneNumber).addFlags(FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static void call(String phoneNumber) {
        Library.INSTANCE.getApp().startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(String phoneNumber, String content) {
        Library.INSTANCE.getApp().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(Library.INSTANCE.getApp(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = Library.INSTANCE.getApp().getContentResolver();
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                if (!TextUtils.isEmpty(contact_id)) {//null   ""
                    ...
                    Cursor c = resolver.query(date_uri, new String[]{
                            "data1", "mimetype"
    ...
    /**
     * 获取手机短信并保存到xml中 <p>需添加权限 {@code <uses-permission android:name="android.permission.WRITE_EXTERNAL_STORAGE"/>}</p>
    ...
    public static void getAllSMS() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                System.out.println(
                        "address:" + address + "   date:" + date + "  type:" + type + "  body:" + body);
            }
