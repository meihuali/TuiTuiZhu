...
public final class AppUtils {
    ...
    public static boolean installAppSilent(final File file, final String params) {
        ...
        if (commandResult.successMsg != null
                && commandResult.successMsg.toLowerCase()
                .contains("success")) {
            return true;
        } else {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager am = (ActivityManager) Library.INSTANCE.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am == null) {
            return false;
        }
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(Library.INSTANCE.getApp().getPackageName());
            }
        }
        return false;
    }
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static String getAppName() {
        return getAppName(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(Library.INSTANCE.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(Library.INSTANCE.getApp()
                .getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(Library.INSTANCE.getApp()
                .getPackageName());
    }
