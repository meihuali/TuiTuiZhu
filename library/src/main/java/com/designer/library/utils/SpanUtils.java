...
public final class SpanUtils {
     ...
     *
     * @param flag The flag. <ul> <li>{@link Spanned#SPAN_INCLUSIVE_EXCLUSIVE}</li> <li>{@link
     *             Spanned#SPAN_INCLUSIVE_INCLUSIVE}</li> <li>{@link Spanned#SPAN_EXCLUSIVE_EXCLUSIVE}</li>
     *             <li>{@link Spanned#SPAN_EXCLUSIVE_INCLUSIVE}</li> </ul>
     ...
     *
     * @param lineHeight The line height, in pixel.
     * @param align      The alignment. <ul> <li>{@link Align#ALIGN_TOP   }</li> <li>{@link
     *                   Align#ALIGN_CENTER}</li> <li>{@link Align#ALIGN_BOTTOM}</li> </ul>
     * @return the single {@link SpanUtils} instance
     */
     ...
     *
     * @param fontFamily The font family. <ul> <li>monospace</li> <li>serif</li> <li>sans-serif</li>
     *                   </ul>
     * @return the single {@link SpanUtils} instance
     */
     ...
     *
     * @param alignment The alignment. <ul> <li>{@link Alignment#ALIGN_NORMAL  }</li> <li>{@link
     *                  Alignment#ALIGN_OPPOSITE}</li> <li>{@link Alignment#ALIGN_CENTER  }</li> </ul>
     * @return the single {@link SpanUtils} instance
     */
     ...
     * @param style  The style. <ul> <li>{@link Blur#NORMAL}</li> <li>{@link Blur#SOLID}</li>
     *               <li>{@link Blur#OUTER}</li> <li>{@link Blur#INNER}</li> </ul>
     * @return the single {@link SpanUtils} instance
     */
     ...
     * @param align  The alignment. <ul> <li>{@link Align#ALIGN_TOP     }</li> <li>{@link
     *               Align#ALIGN_CENTER  }</li> <li>{@link Align#ALIGN_BASELINE}</li> <li>{@link Align#ALIGN_BOTTOM
     *               }</li> </ul>
     * @return the single {@link SpanUtils} instance
     */
    ...
    private void updateCharCharSequence() {
        ...
        if (quoteColor != COLOR_DEFAULT) {
            mBuilder.setSpan(new CustomQuoteSpan(quoteColor, stripeWidth, quoteGapWidth),
                    start,
                    end,
                    flag);
        }
...
//        }
        ...
        if (shadowRadius != -1) {
            mBuilder.setSpan(new ShadowSpan(shadowRadius, shadowDx, shadowDy, shadowColor),
                    start,
                    end,
                    flag);
        }
...
//            }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(Library.INSTANCE.getApp().getResources(), b);
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                Bitmap bitmap;
                try {
                    InputStream is = Library.INSTANCE.getApp().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(Library.INSTANCE.getApp().getResources(), bitmap);
                ...
                try {
                    drawable = ContextCompat.getDrawable(Library.INSTANCE.getApp(), mResourceId);
                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
                } catch (Exception e) {
