...
public final class NetworkUtils {
    ...
    public static boolean isAvailableByPing(String ip) {
        ...
        ShellUtils.CommandResult
                result = ShellUtils.execCmd(String.format("ping -c 1 %s", ip), false);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) Library.INSTANCE.getApp()
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) Library.INSTANCE.getApp()
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) Library.INSTANCE.getApp()
     ...
     * {@code <uses-permission android:name="android.permission.ACCESS_NETWORK_STATE" />}</p>
     *
     * @return type of network <ul> <li>{@link NetworkType#NETWORK_WIFI   } </li> <li>{@link
     * NetworkType#NETWORK_4G     } </li> <li>{@link NetworkType#NETWORK_3G     } </li> <li>{@link
     * NetworkType#NETWORK_2G     } </li> <li>{@link NetworkType#NETWORK_UNKNOWN} </li> <li>{@link
     * NetworkType#NETWORK_NO     } </li> </ul>
     */
    @RequiresPermission(ACCESS_NETWORK_STATE)
